...
use aries_vcx_agent::{Agent, aries_vcx::messages::connection::request::Request as ConnectionRequest};
use inquire::Select;
...
pub async fn process_connection_request_message_command(agent: Arc<RwLock<Agent>>, request: ConnectionRequest) -> anyhow::Result<LoopStatus> {
